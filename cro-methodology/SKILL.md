...
Use surveys, chat logs, support tickets to capture the "voice of the customer." See [OBJECTIONS.md](references/OBJECTIONS.md) for O/CO framework.
...
See [COPYWRITING.md](references/COPYWRITING.md) for persuasion techniques.
